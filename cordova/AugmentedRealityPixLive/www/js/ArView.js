var ArView = function (closeArView) {
	...
	console.log("Initializing");
		...
		onEnterContextHandler = this.onEnterContext.bind(this);
    ...
    this.show = function () {
		...
		console.log(window.cordova.plugins.PixLive);
		*/
        arView.disableTouch();
        this.bindEvents();
    };
    ...
    this.onPresentAnnotations = function (event) {
		console.log("onPresentAnnotations");
        arView.enableTouch();
        var elem;
	...
	this.onEnterContext = function (event) {
        console.log("EnterCOntex");
		console.log(event);
    };
    ...
    this.bindEvents = function () {
		...
		//this.addListener("enterContext", onEnterContextHandler);
    };
    ...
    this.unbindEvents = function () {
		...
		//this.removeListener("enterContext", onEnterContextHandler);
    };
